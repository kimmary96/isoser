...
describe("landing-c program utils", () => {
  it("builds live board from this week's hottest recruiting programs", () => {
    const programs = [
      createProgram({ id: "expired", title: "지난 공고", days_left: -1, rating_display: "4.9", review_count: 50 }),
      createProgram({ id: "hot-1", title: "이번 주 인기 1", days_left: 2, rating_display: "4.9", review_count: 120 }),
      createProgram({ id: "hot-2", title: "이번 주 인기 2", days_left: 5, rating_display: "4.8", review_count: 90 }),
      createProgram({ id: "hot-3", title: "이번 주 인기 3", days_left: 1, rating_display: "4.7", review_count: 80 }),
      createProgram({ id: "late", title: "다음 달 공고", days_left: 14, rating_display: "5.0", review_count: 200 }),
    ];
