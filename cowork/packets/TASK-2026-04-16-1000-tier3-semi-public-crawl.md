...
**파일:** `backend/rag/collector/tier3_collectors.py` (신규 또는 기존 regional 파일과 분리)
...
**파일:** `backend/rag/collector/tier3_collectors.py` (KobiaCollector와 동일 파일)
...
- `KobiaCollector`, `KisedCollector`를 Tier 3 그룹으로 import 및 등록
