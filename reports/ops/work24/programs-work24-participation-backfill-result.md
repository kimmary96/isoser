...
- `reports/ops/work24/programs-work24-participation-backfill-*.json`
- `reports/ops/work24/programs-work24-browse-pool-participation-backfill-*.json`
- `reports/ops/work24/programs-work24-participation-read-model-*.json`
...
## Operational results
- Current Work24 candidates: `reports\ops\work24\programs-work24-participation-backfill-current-apply.json`
  - candidate_count: 80
  - applied_count: 80
- Default browse pool: `reports\ops\work24\programs-work24-browse-pool-participation-backfill-apply.json`
  - candidate_count: 300
...
- Full `refresh_program_list_index(300)` still fails in the current operating DB with `canceling statement due to statement timeout`; see `reports\ops\work24\programs-work24-participation-read-model-refresh.json`.
