...
- 기준 시안: `reports/program-detail-reference-desktop.png`
- 개선 전/상태 확인: `reports/program-detail-current-state.png`
- 개선 후 데스크톱: `reports/program-detail-current-improved-desktop.png`
- 개선 후 모바일: `reports/program-detail-current-improved-mobile.png`
